            ...
            <div className=" w-full  flex flex-col justify-center items-center mt-5 p-5" >
                ...
                <form method="POST"
                    ...
                    <input
                        ...
                        className="m-3 p-2 px-20 bg-gray-900 border-2  rounded-md text-white text-center focus:outline-none " />
                    <input
                        type="text"
                        name="email"
                    ...
                    <textarea name=""
                        ...
                        className="m-3 p-2  bg-gray-900 border-2 rounded-md text-white text-center focus:outline-none ">
                    </textarea >
